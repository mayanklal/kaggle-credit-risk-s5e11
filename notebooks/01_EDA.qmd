...
From the box plot, it can be seen that the interest_rate of the customers who have paid back their loan is lower than the customers who didn't pay back their loan.
...
#| fig.height: 8
#| fig.align: "center"
plot_bubble_chart <- function(data, var, target_var) {
bubble_dti <- data %>%
  group_by({{var}}) %>%
  summarise(
...
plot_bubble_chart(train_num_bins, DTI_Bins, loan_paid_back)
```
...
#| fig.height: 8
#| fig.align: "center"
plot_bubble_chart(train_num_bins, CreditScore_Bins, loan_paid_back)
```
...
#| fig.height: 8
#| fig.align: "center"
plot_bubble_chart(train_num_bins, InterestRate_Bins, loan_paid_back)
```
