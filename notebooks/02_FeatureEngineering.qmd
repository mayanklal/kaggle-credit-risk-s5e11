...
In line with the guidance from Chris's notebook, we will be performing feature engineering within the nested folds of our cross-validation based model training workflow. Therefore, we will be doing it in our **Model Development** notebook.
